        ...
        <div className="container">
          <div className="camping__layout">
            <div className="camping__photo">
              <img src="/images/batramp2.jpg" alt="Båtramp vid Hären" className="camping__photo-image" />
            </div>
            <div className="camping__content">
              <p className="camping__content-label">Välornas Camping</p>
              <h2 className="camping__content-title">Sov nära vattnet</h2>
              ...
              <a href={campingUrl} target="_blank" rel="noopener noreferrer" className="btn btn--outline-dark camping__cta">
                Besök Välornas Camping →
              </a>
            </div>
          </div>
        </div>
